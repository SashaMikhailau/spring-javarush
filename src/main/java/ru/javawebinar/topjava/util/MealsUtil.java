...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 20, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 20, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 20, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 21, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 21, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2019, Month.FEBRUARY, 21, 20, 0), "Ужин", 510)
    );
